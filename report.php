			...
			<div id="mainbar" class="col-md-8 col-md-offset-2">
				...
				<div class="frame">
					...
					<div class="report">
						...
						<p>MHelper plans to apply soft launch: it will start from a section of the whole UM campus – School of Information (UMSI) – and a section of categories such as programming. According to the interactions in the mailing list si.all.open, UMSI is chosen as an active community and programming is a hot field with many help seeking requests. Thus, for the initial stage, the whole SI community and some of the on-campus volunteer organizations will be invited to join MHelper. Some special badges will be prepared for the first bunch of users as incentive. Then, we will expand the user population and task categories steadily while refining the system based on the feedback we collect.</p>
						<p>MHelper, designed as a campus-wide intelligence exchange platform, envision a self-sustaining status where a task in any field can be helped in a reasonable time. The critical mass should be a balance of the two main roles – Helpers and Helpees. Since the range of specialties is also important to the performance of MHelper, the critical mass is expected to cover a range wide enough. The strategy to achieve the critical mass status is to expand the user population steadily by invitation while controlling the quality of the content and interaction in MHelper through our reputation system. We will keep evaluating and refining MHelper to better implement the strategy and accelerate this process.</p>
